...
public class GameUnit extends GameEntity {	
	 ...
	 * Update function
	 */
	public void update(HashSet<GameUnit> entities, Player player) {
		// default actions
	...
	public void draw(Graphics2D g2d, float delta) {
		...
		g2d.fillOval(x - (int)(velx * (1-delta)) -10, y - (int)(vely * (1-delta)) -10, 20, 20);
		
		//g2d.setColor(Color.black);
		//g2d.drawString(health + "/" + MAX_HEALTH, x-(velx * (1-delta))-20, y -(int)(vely * (1-delta))- 20);
		
		g2d.setColor(Color.green);
		g2d.fillRect(x-(int)(velx * (1-delta))-20, y -(int)(vely * (1-delta))- 20, 45 * health/MAX_HEALTH, 5);
